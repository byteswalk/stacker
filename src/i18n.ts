...
const CURATED_EN: Record<string, string> = {
  ...
  "矩形面积按实际磁盘占用计算；单击下钻目录，右键直接打开目录。": "Rectangle area represents allocated disk space. Click to drill down; right-click to open a directory.",
  ...
  "确认清理计划": "Confirm Cleanup Plan",
  "开始清理": "Start Cleanup",
  "清理失败：": "Cleanup failed: ",
  "部分项目需要管理员权限": "Some items require administrator access",
  "已处理": "Processed",
  "我已确认所选目录和影响，允许执行此清理计划。": "I have reviewed the selected paths and their impact and approve this cleanup plan.",
